...
import { AsitsVideoRecorder as AsitsVideoRecorderDefinition } from '.';
...
export const CLog = (...args) => {
  if (CameraUtil.debug) {
    console.log('NativeScript-AsitsVideoRecorder ---', args);
  }
};

export type CameraTypes = 'front' | 'rear';

export abstract class AsitsVideoRecorderBase extends ContentView implements AsitsVideoRecorderDefinition {
